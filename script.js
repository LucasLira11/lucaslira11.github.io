...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Adiciona o evento de clique ao ícone do menu hambúrguer para dispositivos móveis
    const hamburgerMenu = document.querySelector('.hamburger-menu');
    const mobileMenu = document.querySelector('.menu');

    if (hamburgerMenu) {
        hamburgerMenu.addEventListener('click', function() {
            // Ação para abrir/fechar o menu em dispositivos móveis
            // A implementação completa de um menu hambúrguer requer a criação de um menu visível
            // apenas em telas pequenas, e alternar sua visibilidade com o clique.
            // O código abaixo serve apenas como um placeholder para a lógica.
            if (mobileMenu) {
    ...
    menuLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (href.startsWith('index.html#')) {
                // Navega para a página inicial e depois para a seção
...
>>>>>>> 7b6229ef077988a0ca10f8d7ef7960d0141c75bf
});